...
from tinycss2 import parse_blocks_contents, parse_one_declaration
...
class Style:
    ...
    @staticmethod
    def from_dict(style: dict[str, str]) -> Style:
        return Style.from_decl(
            [
    ...
    @staticmethod
    def from_str(style: str) -> Style:
        return Style.from_decl(
            parse_blocks_contents(style, skip_comments=True, skip_whitespace=True)
        )

    @staticmethod
    def from_decl(style: list[Declaration]) -> Style:
        return Style(**adapters.get_props(style))
